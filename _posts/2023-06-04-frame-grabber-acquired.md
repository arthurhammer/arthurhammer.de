...
This has been a wild ride! After 5 years on the App Store, I felt it was time. I've built and run this venture from start to finish. It started as a solo product to solve a problem I had and grew from there. Back then, I had an idea but no clear roadmap for making an app. So I sat down and got to work.

Being an indie developer ends on a high note for me. The app has tens of thousands of daily downloads, tens of thousands of daily active users, and a 4.8 star rating world-wide. It's a good app, it solves a real problem, and it does it [really well](https://github.com/arthurhammer/FrameGrabber/blob/develop/docs/about.md#technical-challenges). It couldn't be a better time to move on.

## How it Happened

The opportunity presented itself. I received an email from somebody interested in acquiring the app. We arrived at an agreement and I said yes. I didn't make the decision lightly. The final offer was significant and, well, simply too hard to pass up. 

I've never sold an app. With Frame Grabber, I wanted to build and run an app from start to finish and here I am: at the finish line. So I got to figure out that part as well, just one part of the journey. I sat down and read up on everything I needed to know. There's contracts, taxes, weird laws, and more paperwork to consider. Especially when selling internationally. It was genuinely fun learning about those things.

## Why

**Time**: I haven't had much time to improve the app recently. Pretty simple. Time is limited besides full-time work and life outside of work. As the user base grew, feature requests kept accumulating. Putting something out there and having people depend on it, is a responsibility. Users count on me as the developer and I started to feel guilty by not honoring that to the extent it deserves.
